...
function load_my_scripts() {
  ...
  wp_enqueue_script( 'lottie-interactive', 'https://unpkg.com/lottie-interactive@latest/dist/lottie-interactive.js', array(), false, true );

  wp_enqueue_script( 'gsap-js', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/3.11.5/gsap.min.js', array(), false, true );
  wp_enqueue_script( 'gsap-js-scroll', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/3.11.5/ScrollTrigger.min.js', array(), false, true );
